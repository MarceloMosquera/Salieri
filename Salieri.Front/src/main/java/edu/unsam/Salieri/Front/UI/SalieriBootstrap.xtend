...
//		f956 => [
//			agregarEscala(
//				new Escala(context.repoAeropuertos.buscarAeropuertoPorNombre("El Calafate (FTE)"), 
//				SSDate.p("20160315 17:00" ),SSDate.p("20160315 17:30" )  
//			))
//			agregarEscala(
//				new Escala(context.repoAeropuertos.buscarAeropuertoPorNombre("El Bolsón (EHL)"), 
//				SSDate.p("20160316 01:00" ),SSDate.p("20160316 01:30" )  
//			))
//			agregarEscala(
//				new Escala(context.repoAeropuertos.buscarAeropuertoPorNombre("Dolores (VDR)"), 
